...
% PROBABILIDADES REALES DE TUS DATOS
% Calcula estos valores de tus datos procesados
prob_AM = 0.9375;    % ? Tu valor real (ej: 93.75%)
prob_FM = 1 - prob_AM;
...
if emisora == 0 % AM
    prob_slow = 0.05;   % ? Tu valor real para AM (ej: 5%)
    ...
    prob_slow = 0.15;   % ? Tu valor real para FM (ej: 15%)
