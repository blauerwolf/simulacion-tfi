...
% Versión final para tus archivos CSV con todas las columnas
...
% Crear timeline con intervalos de 60 segundos (ajusta según necesidad)
...
save('parametros_simulacion_final.mat', 'parametros', 'master_data', 'am_stats', 'fm_stats');
...
saveas(gcf, 'datos_reales_procesados.png');